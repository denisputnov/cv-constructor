...
const UnsupportedResolution = () => {
  ...
  const unsupportedMessage = {
    ru: "К сожалению, разрешение вашего устройства на данный момент не поддерживается. Пожалуйста, попробуйте использовать широкоформатный экран вашего персонального компьютера или ноутбука. Вы можете сохранить ссылку на этот сервис и вернуться к просмотру позднее.",
